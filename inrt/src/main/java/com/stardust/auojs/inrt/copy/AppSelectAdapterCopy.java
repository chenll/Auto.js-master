...
public class AppSelectAdapterCopy extends BaseQuickAdapter<AppBean, BaseViewHolder> {

    public AppSelectAdapterCopy(int layoutResId, @Nullable List<AppBean> data) {
