...
function closeDialog() {
    ...
    //    closeDialogByid("cn.youth.news:id/tv_pass");
    //    closeDialogByid("android:id/button2");
    //    closeDialogByid("cn.youth.news:id/iv_close");
    //    closeDialogByid("cn.youth.news:id/btn_close");
